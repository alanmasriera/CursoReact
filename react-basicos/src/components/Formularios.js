...
//                 <input type="radio" id="esvelte" name="sabor" value="esvelte" onChange={(e) => setSabor(e.target.value)}/>
//                 <label htmlFor="esvelte">esvelte</label>
    ...
    return(
        <>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <label htmlFor="vue">vue</label>
                <input type="radio" id="esvelte" name="sabor" value="esvelte" onChange={handleChange}/>
                <label htmlFor="esvelte">esvelte</label>
                <p>Elige tu lenguaje de programacion favorito</p>
